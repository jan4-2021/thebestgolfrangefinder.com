		...
		$(document).ready( function(){
			...
			$( window ).ready( function(){
				if ( $.fn.fitVids ) {
					...
					$( '.et_pb_module' ).fitVids( { customSelector: "iframe[src^='https://web.archive.org/web/20180817184040/http://www.hulu.com'], iframe[src^='https://web.archive.org/web/20180817184040/http://www.dailymotion.com'], iframe[src^='https://web.archive.org/web/20180817184040/http://www.funnyordie.com'], iframe[src^='https://web.archive.org/web/20180817184040/https://embed-ssl.ted.com'], iframe[src^='https://web.archive.org/web/20180817184040/http://embed.revision3.com'], iframe[src^='https://web.archive.org/web/20180817184040/https://flickr.com'], iframe[src^='https://web.archive.org/web/20180817184040/http://blip.tv'], iframe[src^='https://web.archive.org/web/20180817184040/http://www.collegehumor.com']"} );
				}
...
/*
     FILE ARCHIVED ON 18:40:40 Aug 17, 2018 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 05:05:58 Jan 04, 2021.
...
/*
playback timings (ms):
  RedisCDXSource: 19.239
  esindex: 0.027
  PetaboxLoader3.resolve: 152.222 (3)
  LoadShardBlock: 210.955 (3)
  CDXLines.iter: 22.165 (3)
  PetaboxLoader3.datanode: 133.325 (4)
  load_resource: 104.138
  exclusion.robots.policy: 0.143
  captures_list: 256.447

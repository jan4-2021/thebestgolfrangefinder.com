...
(function($){
	...
	$(document).ready( function(){
		...
		$( window ).ready( function(){
			if ( $.fn.fitVids ) {
				$( '#main-content' ).fitVids( { customSelector: "iframe[src^='https://web.archive.org/web/20180817175206/http://www.hulu.com'], iframe[src^='https://web.archive.org/web/20180817175206/http://www.dailymotion.com'], iframe[src^='https://web.archive.org/web/20180817175206/http://www.funnyordie.com'], iframe[src^='https://web.archive.org/web/20180817175206/https://embed-ssl.ted.com'], iframe[src^='https://web.archive.org/web/20180817175206/http://embed.revision3.com'], iframe[src^='https://web.archive.org/web/20180817175206/https://flickr.com'], iframe[src^='https://web.archive.org/web/20180817175206/http://blip.tv'], iframe[src^='https://web.archive.org/web/20180817175206/http://www.collegehumor.com']"} );
			}
		} );
...
/*
     FILE ARCHIVED ON 17:52:06 Aug 17, 2018 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 05:06:11 Jan 04, 2021.
...
playback timings (ms):
  ...
  PetaboxLoader3.resolve: 47.577
  PetaboxLoader3.datanode: 60.869 (4)
  captures_list: 76.159
  LoadShardBlock: 47.163 (3)
  exclusion.robots.policy: 0.2
  RedisCDXSource: 0.764
  load_resource: 99.317
*/